...
def save_checkpoint(model_list, optimizer, save_dir, epoch, lr_scheduler=None):
...
def load_checkpoint(model_list, optimizer, save_dir, epoch=-1, load_to_device_name=None,
        lr_scheduler=None):
